...
<head >
  ...
  <script>
      $(function(){
          $("#add").click(function(){
              if($("#username").val()==""){
                  $("#uerror").html("不可以不输入姓名！");
                  return ;
              }
              if($("#password").val()==""){
                  $("#perror").html("不可以不输入密码！");
                  return ;
              }
    ...
    <div class="tablecontainer">
      <table class="table table-hover">
        ...
        <tr>
          ...
          <td>
            <a href="checkuser.jsp?action=queryid&id=<%=user.getId()%>"  class="btn btn-success custom-width">编辑</a>
            <a href="checkuser.jsp?action=del&id=<%=user.getId()%>"  class="btn btn-danger custom-width">删除</a>
          </td>
